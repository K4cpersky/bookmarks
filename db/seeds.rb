...
b11 = Book.create(title: "Lord of The Rings", author: "J.R.R. Tolkien", description: "A history about the Fellowship of The Ring fighting against evil Sauron", publisher: "Merlin", weeks_on_list: 100, rank_this_week: 11)
b12 = Book.create(title: "The Witcher", author: "A. Sapkowski", description: "A history about Geralt The Witcher and his adventures.", publisher: "Merlin", weeks_on_list: 96, rank_this_week: 12)
...
Review.create(comment: "Just awesome!", author: "K. Mekarski", book_id: b11.id)
Review.create(comment: "Incredible!", author: "K. Mekarski", book_id: b11.id)

Review.create(comment: "Pure magic!", author: "K. Mekarski", book_id: b12.id)
Review.create(comment: "Legendary!", author: "K. Mekarski", book_id: b12.id)